"""
Django settings for ThinkOpenHealthApp project.
...
SECRET_KEY = 'oc_j#8uj)y9h-byl0wk53i&si$ykv_bua^6pjhhq!6_p_xj)_&'
...
ROOT_URLCONF = 'ThinkOpenHealthApp.urls'
...
WSGI_APPLICATION = 'ThinkOpenHealthApp.wsgi.application'
